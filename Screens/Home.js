    ...
    function renderMainCategory() {
            ...
            return (
                <TouchableOpacity
                    style={{
                        ...
                        backgroundColor: (selectedCategory?.id === item.id ? "#FC6D3F" : "#FFFFFF"),
                        borderRadius: 30,
                        alignItems: "center",
                        justifyContent: "center",
                        marginRight: 10,
        ...
        return (
            <View style={{ padding: 20 }}>
                <Text style={{ fontSize: 25, fontWeight: "bold" }}>Delicious Food</Text>
                <Text>Discover and Get Great Food</Text>
                        ...
                        {/* Price */}
                        {
                            [1, 2, 3].map((priceRating) => (
                                <Text
                                    key={priceRating}
                                    style={{
                                        color: (priceRating <= item.priceRating) ? "#1E1F20" : "#898C95"
                                    }}
                                >$</Text>
                            ))
                        }
